...
class TestPacker(unittest.TestCase):
    ...
    def test_dynamic_queue_addition(self):
        ...
        self.packer.add_to_queue(sequences_1)
        first_pack = next(self.packer)

        self.packer.add_to_queue(sequences_2)
        second_pack = next(self.packer)
